...
{
    public ParametersCondition(IEnumerable<NudgeParameter> parmeters) => _transtionCondtions = parmeters;
    ...
    public bool CheckCondition(IEnumerable<NudgeParameter> conditions) => _transtionCondtions.All(x => conditions.Contains(x));
}
